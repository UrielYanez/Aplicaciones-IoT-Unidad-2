...
color1 = Pin(15, Pin.OUT)
color2 = Pin(17, Pin.OUT)
...
while True:
    color1.value(1)
    color2.value(0)
    print("Color 1 prendido")
    client.publish(MQTT_TOPIC, f"Amarillo")
    sleep(1)
    
    color1.value(0)
    color2.value(1)
    print("Color 2 prendido")
    client.publish(MQTT_TOPIC, f"Rojo")
    sleep(1)
